 ...
 *
 * <p>This class handles all exceptions thrown by controllers and provides consistent error response
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleApiException(final KiteApiException ex) {
  ...
  /**
   * Handles static resource not found (e.g. missing favicon, unknown paths). Logged at DEBUG level
   * since these are typically harmless browser requests.
   *
