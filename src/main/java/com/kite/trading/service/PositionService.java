 ...
 * 
 * This interface defines the contract for position-related operations
 * with the Zerodha Kite API, following the Interface Segregation Principle.
 * 
...
public interface PositionService {
     ...
     * 
     * This method fetches both net positions and day trading positions
     ...
     * 
     * This method filters positions to return only those with:
     * - Trading symbol containing "NIFTY"
