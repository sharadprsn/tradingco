 ...
 * 
 * This DTO encapsulates all relevant information about a trading position
 * including instrument details, quantity, average price, and P&L information.
 * 
...
public record Position(
        ...
        @JsonProperty("day_quantity")
        Integer dayQuantity,
        
        @JsonProperty("night_quantity")
        Integer nightQuantity
) {
}
