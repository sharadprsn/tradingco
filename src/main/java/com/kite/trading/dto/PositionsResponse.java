 ...
 *
 * <p>This DTO represents the response structure when fetching all positions from the Zerodha Kite
 * API.
 *
...
public record PositionsResponse(
    @JsonProperty("status") String status, @JsonProperty("data") PositionsData data) {
  ...
  public record PositionsData(
      @JsonProperty("net") List<Position> net, @JsonProperty("day") List<Position> day) {}
}
