    ...
    try {
      ...
      if (data != null && data.records() != null) {
        ...
        final boolean hasOi =
            hasData
                && records.data().stream()
                    .anyMatch(
                        o ->
                            (o.pe() != null && o.pe().openInterest() != null)
                                || (o.ce() != null && o.ce().openInterest() != null));
        logger.info(
            "[NSE] Connection OK - underlying: {}, data records: {}, OI data available: {}",
        ...
        if (records.underlyingValue() != null) {
          ...
          logger.info(
              "[NSE] Sample OI at strike {} - PE: {}, CE: {}",
              firstOption.strikePrice(),
              formatOi(peOi),
              formatOi(ceOi));
        }
      } else {
        logger.warn(
            "[NSE] Connection established but no option chain data returned (markets may be closed)");
      }
