 ...
 * 
 * This controller provides endpoints for fetching trading positions
 * from the Zerodha Kite API, following the Single Responsibility Principle.
 * 
...
public class PositionController {
     ...
     * 
     * This endpoint returns both net positions and day trading positions
     ...
     * 
     * This endpoint filters positions to return only:
     * - Instruments with trading symbol containing "NIFTY"
     * - Positions with product type "MIS" (intraday)
     *
